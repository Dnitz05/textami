...
const DocumentPreviewPanel: React.FC<DocumentPreviewPanelProps> = ({
  ...
  return (
    <div className="bg-white">
      ...
      <div className="py-4 border-b border-gray-200/50 bg-gray-50/40 backdrop-blur-sm flex-none">
            ...
            <div className="flex items-center space-x-1">
              {isEditingName ? (
                <input
                  ...
                  className="text-sm font-semibold text-gray-800 bg-white border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-purple-500 min-w-48"
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-600 p-1 rounded hover:bg-gray-100 transition-all ml-2"

      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 bg-gray-100 overflow-y-auto relative">
          <div className="flex justify-center">
            <div className="bg-white shadow-2xl relative" style={{width: '210mm'}}>
              {/* Left Sidebar - positioned to align right edge with left edge of template */}
              {showLeftSidebar && (
                <div className="fixed top-14 bottom-0 w-80 bg-white border-r border-gray-300 shadow-lg flex flex-col z-10" 
                     style={{right: 'calc(50% + 105mm)'}}>
                  {/* Sidebar Header */}
                  <div className="px-4 py-3 border-b border-gray-300 bg-gray-50 shadow-sm flex-none">
              ...
              {showRightSidebar && (
                <div className="fixed top-14 bottom-0 w-80 bg-white border-l border-gray-300 shadow-lg flex flex-col z-10" 

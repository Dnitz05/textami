        ...
        <div className="flex-1 bg-gray-100 overflow-y-auto relative">
          <div className="flex justify-center py-8 px-4">
            <div className="bg-gray-100 shadow-2xl border border-gray-200 rounded-2xl relative" style={{width: '210mm'}}>
              ...
              {showLeftSidebar && (
                <div className="fixed w-80 bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/30 flex flex-col z-10 m-4" 
                     style={{right: 'calc(50% + 105mm)', top: '4.5rem', bottom: '1rem'}}>
                  {/* Sidebar Header */}
                  <div className="px-6 py-5 border-b border-gray-200/50 bg-white/40 backdrop-blur-sm rounded-t-2xl flex-none">
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-6 bg-white/40 backdrop-blur-sm">
                    <AIPromptsPanel 
                      pipelineStatus={pipelineStatus}
              ...
              {showRightSidebar && (
                <div className="fixed w-80 bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/30 flex flex-col z-10 m-4" 
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-6 bg-white/40 backdrop-blur-sm rounded-b-2xl">
                    <ExcelMappingPanel 
